...
export function PasswordGate({ children }) {
  ...
  // Read the unlock flag once on mount. Splitting this from the initial
  // useState avoids hydration mismatches and a flash of the gate for
  // returning visitors.
  useEffect(() => {
    try {
    ...
    >
      <div className="w-full max-w-[380px] flex flex-col items-center text-center">
        ...
        <p className="text-[14px] leading-[20px] font-[450] text-[#6D6C6A] mb-[28px]">
          Private design trial. Enter the password to continue.
        </p>
